<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userManagement.aspx.cs" Inherits="Library_management_system.userManagement" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row " style="margin-top:12px">
                     <div class="col-8 mx-auto">
                         <asp:Button ID="Button2" class="btn w-100 btn-danger" runat="server" Text="Delete User Permanently" OnClick="Button2_Click" />
                     </div>
                  </div>
               </div>
            </div>
